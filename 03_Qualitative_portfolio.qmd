# Qualitative Portfolio (Group) {#ch3_AIS_portfolio}
...
## Intended Learning Outcomes (ILOs) {#portfolio_ILOs}
...
3.  Quality of the Academic Communication
    ...
    -   Write clearly and succinctly with appropriate use of paragraphs, spelling and grammar, following APA 7th guidelines for all citations and references (#1: Qual questions, #2 Ethics, #3: Focus group)
...
-   Guidance on how to complete the group portfolio will be provided as part of the course. These will be released on Moodle, but you will also be able to find all key resources in [the Group Project Chapter](#ch10_group_project).

-   Further information about feedback can be found in [the Feedback section](#portfolio_feedback)
...
-   FAQs from previous students can be found in [the FAQs Chapter](#ch13_faqs)
...
-   We use the [Intended Learning Outcomes presented above](#portfolio_ILOs) to mark this assessment.
