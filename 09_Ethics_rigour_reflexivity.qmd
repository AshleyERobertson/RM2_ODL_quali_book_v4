...
Look at the methods sections of these studies and try to identify how they have addressed ethical issues
  ...
  * [Scott et al., 2019](https://www.sciencedirect.com/science/article/pii/S2352721819301457#s0010){target="_blank"}
  * [Sutton & Stack, 2013](https://academic.oup.com/bjsw/article/43/3/596/1636960?login=true){target="_blank"}
  * [Robertson & Simmons, 2015](https://journals.sagepub.com/doi/pdf/10.1068/p7833){target="_blank"}
...
Please note: Some information below is included in the video for [Research Skills for data analysis](#reflexivity_skills_session) as well.

We ask you to think about your own position in the research as part of your report (there is a section in the methods, and you need to include a [reflexivity diary](https://gla-my.sharepoint.com/:w:/g/personal/ashley_robertson_glasgow_ac_uk/IQC1PIxhBlndR74S_nfeKHNlAW5uQmGOpoRXCpLHC2fI_fI?e=aunShJ){target="_blank"} as an appendix to your report!).
...
Here we have some data from Braun & Clarke - there are different datasets to choose from. If you want to use the ones from Braun & Clarke, you can either choose the ['childfree'](https://gla-my.sharepoint.com/:w:/g/personal/ashley_robertson_glasgow_ac_uk/EWq1HW7Xm_BKnobsU_GRpcIBlSvnQ4k6XhFqBkszClAwWg?e=q4lc97){target="_blank"} dataset or the ['healthy eating'](https://gla-my.sharepoint.com/:w:/g/personal/ashley_robertson_glasgow_ac_uk/EdfitbKwhodKo8Kmj9szNgwBNmt313A8dYknAiehHdy2lg?e=0vWOnu){target="_blank"} dataset. However, we know that some topics might be difficult for people, so please do choose a topic of your own preference if you would rather  - any qualitative dataset (e.g.from UK Data Service) or news article would be fine.
...
Ashley has some additional reflexivity probes and tips in her [research skills session](#reflexivity_skills_session).
